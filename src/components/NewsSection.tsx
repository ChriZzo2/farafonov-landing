            ...
            <div className="text-center animate-scaleIn">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    ...
                    >
                        ...
                        <span className="relative inline-block bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-800 hover:to-gray-900 text-white font-bold text-lg sm:text-xl md:text-2xl py-4 sm:py-5 px-10 sm:px-12 md:px-14 rounded-full shadow-2xl transform group-hover:scale-110 transition-all duration-300 flex items-center gap-3">
              ...
              Telegram
                ...
                <p className="mt-6 text-gray-300 text-base sm:text-lg font-medium">
