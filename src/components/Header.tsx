export default function Header() {
    return (
        <header className="relative text-center py-16 md:py-24 px-4 overflow-hidden bg-gradient-to-b from-dark via-gray-800 to-transparent">
            {/* Анимированный фон */}
            ...
            <div className="relative z-10">
                ...
                <p className="text-xl sm:text-2xl md:text-3xl text-gray-200 font-medium px-4 animate-slideUp drop-shadow-lg" style={{ animationDelay: '0.2s' }}>
